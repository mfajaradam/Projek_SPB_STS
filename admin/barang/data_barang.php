...
$query = tampil_data('SELECT * FROM barang');
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <?php foreach ($query as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($data['jumlah'] == 0) {
                                                        echo "
                                                            <button type='' class='btn btn-danger'>tidak tersedia</button>
                                                        ";
                                                    } else {
                                                        echo "
                                                            <a class='btn btn-success' href='../peminjaman/tambah_data.php' role='button'>Tersedia</a>
                                                        ";
                                                    }
                                                    ?>
                                                </td>
