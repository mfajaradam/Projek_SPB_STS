...
$id = tampil_data("SELECT * FROM barang WHERE id = '$ids'")[0];
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="kodebarang" placeholder="kode barang" name="kode_barang" required value="<?= $id['kode_barang']; ?>">
                                    <label for="kodebarang">Kode Barang</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="namabarang" placeholder="nama barang" name="nama_barang" required value="<?= $id['nama_brg']; ?>">
                                    <label for="namabarang">Nama Barang</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="ktg" placeholder="kategori" name="kategori" name="kategori" required value="<?= $id['kategori']; ?>">
                                    <label for="ktg">Kategori</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="merk" placeholder="merk" name="merk" required value="<?= $id['merk']; ?>">
