                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="noidentitas" placeholder="no identitas" name="no_identitas" required>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="status" placeholder="status" name="status" name="status" required>
