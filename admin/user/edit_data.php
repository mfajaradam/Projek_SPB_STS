...
$id = tampil_data("SELECT * FROM user WHERE id = '$ids'")[0];
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="noidentitas" placeholder="no identitas" name="no_identitas" required value="<?= $id["no_identitas"]; ?>">
                                    <label for="noidentitas">No Identitas</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="nama" placeholder="nama" name="nama" required value="<?= $id["nama"]; ?>">
                                    <label for="nama">Nama</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="status" placeholder="status" name="status" name="status" required value="<?= $id["status"]; ?>">
                                    <label for="status">Status</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="username" placeholder="username" name="username" required value="<?= $id["username"]; ?>">
                                    <label for="username">Username</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="password" placeholder="password" name="password" required value="<?= $id["password"]; ?>">
                                    <label for="password">Password</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="role" placeholder="role" name="role" required value="<?= $id["role"]; ?>">
