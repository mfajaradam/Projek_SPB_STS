...
if (isset($_POST['submit'])) {
    if (tambah_peminjaman($_POST) > 0) {
        echo "
            <script>
                alert ('Pinjam berhasil ditambahkan!');
        ...
        echo "
            <script>
                alert ('Pinjam gagal ditambahkan!');
                document.location.href = 'data_peminjaman.php';
            </script>
        ";
    }
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="tanggalpinjam" placeholder="tanggal pinjam" name="tanggal_pinjam" value="<?= isset($id['tanggal_pinjam']) ? date('Y-m-d') : '' ?>" required>
                                    <label for="tanggalpinjam">Tanggal Pinjam</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="tanggalkembali" placeholder="tanggal kembali" name="tanggal_kembali" value="<?= isset($id['tanggal_kembali']) ? date('Y-m-d') : '' ?>">
                                    <label for="tanggalkembali">Tanggal Kembali</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="noidentitas" placeholder="no identitas" name="no_identitas" name="no_identitas" required>
                                ...
                                <div class=" form-floating mb-3">
                                    <input type="text" class="form-control" id="keperluan" placeholder="keperluan" name="keperluan" required>
